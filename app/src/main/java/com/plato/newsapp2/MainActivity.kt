...
import com.plato.newsapp2.News
import com.plato.newsapp2.NewsAdaptor

class MainActivity : AppCompatActivity(), NewsAdaptor.OneNewsClick {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // to set layout of our recyclerView as linear layout
    ...
    // now in a our main activity we made api call
